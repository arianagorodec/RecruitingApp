        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <p>Добро пожаловать в ваш аккаунт сотрудника. Данный аккаунт предоставляет вам возможность просматривать статистику за определённый период.</p><p>
              В аккаунте содержится ваша личная информация. Так же здесь размещается календарь событий, который включает в себя расписание встреч, больничных и отпусков. При помощи вашей странички вы можете просматривать и добавлять результаты кандидатов, добавлять вакансии и анализировать кандидатов </p>
            ...
            <div class="media" style=" width:1400px;">
              ...
              <div class="media-body">
                <div class="personal_text">
                  ...
                  <h3>${name}</h3>
                  <h4>Сотрудник</h4>
                  <p>HR. В обязаности HR входит контроль и найм сотрудников, а так же отчётность по некоторым вопросам, предоставляемые другим отделам</p>
